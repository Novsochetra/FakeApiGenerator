...
router
    ...
    const paginateData = address_1.default.paginate(parseInt((_a = page === null || page === void 0 ? void 0 : page.toString()) !== null && _a !== void 0 ? _a : "1"), parseInt((_b = per_page === null || per_page === void 0 ? void 0 : per_page.toString()) !== null && _b !== void 0 ? _b : "10"));
    return res.json({
        data: paginateData,
